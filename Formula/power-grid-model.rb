...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.12.109.tar.gz"
  sha256 "d3138ccb9db5d5ff007efb65a2291ca6e4a67179cd90dba3ede4a83d3caaf089"
  license "MPL-2.0"
