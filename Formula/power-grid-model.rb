...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.12.111.tar.gz"
  sha256 "668c1e64008b12d3615074f6ee20ce2a0c159ede3331b1820185a5035d32043f"
  license "MPL-2.0"
