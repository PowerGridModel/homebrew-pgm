...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.12.89.tar.gz"
  sha256 "f8fb133155f0a4513652c5a45435104a6178bcaf6adccb58f0b76d671177072e"
  license "MPL-2.0"
