...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.13.0.tar.gz"
  sha256 "ced46c9dc42d84cde4cd22e22fc66b3b3fbb9cbf70a1a4bd677420fe473251f5"
  license "MPL-2.0"
