...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.13.10.tar.gz"
  sha256 "d7db84781085f2337791801ec16764c4920f54d766e99add6bb079c26da7b790"
  license "MPL-2.0"
