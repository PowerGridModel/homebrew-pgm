...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.12.88.tar.gz"
  sha256 "b2cdbad472f6e7a70df3a07a604ecb27d4f67edc582f05b034c95b7604180d5d"
  license "MPL-2.0"
