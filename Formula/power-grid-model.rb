...
class PowerGridModel < Formula
  ...
  url "https://github.com/PowerGridModel/power-grid-model/archive/refs/tags/v1.11.0.tar.gz"
  sha256 "31cc9d587107bd88763b3fc14872024dce3bf9061860bd1ecaa76955cdbfccfd"
  license "MPL-2.0"
